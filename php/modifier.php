...
?>
  ...
  <article class="article">
    <h2 class="title_add">Add a new Recipies</h2>
    ...
    if ($_SESSION['id'] == '4') {
      ...
      <option value="0">Desactivate</option>
          ...
          <textarea class="resume" name="description" placeholder="Recipies resume.."><?= $description ?></textarea>
        ...
        <div class="grid2">
          ...
          <input type="text" id="cingr" name="chol" placeholder="Cholesterol mg..."  value="<?= $calories ?>"/>
            <input class="btn_add" type="submit" value="Publish edited recipies" />
          </div>
          <div class="gridetape">
            <h2>Directions:</h2>
